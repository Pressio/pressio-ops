option(PRESSIO_OPS_ENABLE_CXX17 "Enable C++17" OFF)
option(PRESSIO_OPS_ENABLE_CXX20 "Enable C++20" OFF)

if(CMAKE_CXX_STANDARD EQUAL 17)
  add_definitions(-DPRESSIO_OPS_ENABLE_CXX17)
elseif(CMAKE_CXX_STANDARD EQUAL 20)
  add_definitions(-DPRESSIO_OPS_ENABLE_CXX20)
endif()

option(PRESSIO_OPS_ENABLE_TPL_EIGEN		  "Enable Eigen TPL"	  OFF)
option(PRESSIO_OPS_ENABLE_TPL_TRILINOS	"Enable Trilinos TPL"	OFF)
option(PRESSIO_OPS_ENABLE_TPL_KOKKOS		"Enable Kokkos TPL"	  OFF)
option(PRESSIO_OPS_ENABLE_TPL_MPI		    "Enable MPI"	      	OFF)

if(PRESSIO_OPS_ENABLE_TPL_EIGEN)
  message(">> Enabling Eigen since PRESSIO_OPS_ENABLE_TPL_EIGEN=ON")
  add_definitions(-DPRESSIO_OPS_ENABLE_TPL_EIGEN)
...
if(PRESSIO_OPS_ENABLE_TPL_TRILINOS)
  message(">> PRESSIO_OPS_ENABLE_TPL_TRILINOS=ON ==> enabling also BLAS, LAPACK, MPI, KOKKOS")
  add_definitions(-DPRESSIO_OPS_ENABLE_TPL_TRILINOS)

  set(PRESSIO_OPS_ENABLE_TPL_KOKKOS ON)
  set(PRESSIO_OPS_ENABLE_TPL_MPI ON)
...
if(PRESSIO_OPS_ENABLE_TPL_KOKKOS)
  message(">> Enabling Kokkos since PRESSIO_OPS_ENABLE_TPL_KOKKOS=ON")
  add_definitions(-DPRESSIO_OPS_ENABLE_TPL_KOKKOS)

  # when trilinos is enabled it links kokkos too
  if(NOT PRESSIO_OPS_ENABLE_TPL_TRILINOS)
...
if(PRESSIO_OPS_ENABLE_TPL_MPI)
  message(">> Enabling MPI since PRESSIO_OPS_ENABLE_TPL_MPI=ON")
  add_definitions(-DPRESSIO_OPS_ENABLE_TPL_MPI)
